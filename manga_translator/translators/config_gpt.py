...
class ConfigGPT:
    ...
    _CHAT_SAMPLE = {
        ...
        'Thai': [
            ...
            (
                "<|1|>อายจัง… ไม่อยากเป็นจุดสนใจ… อยากหายไปเลย…\n"
                "<|2|>เธอ… ไม่เป็นไรนะ⁉\n"
                "<|3|>ไอ้นี่มัน… อ่านบรรยากาศไม่ออกเหรอวะ…？\n"
                "<|4|>พี่! มาเร็วๆ สิ!\n"
                "<|5|>ชิ… ทำไม่ได้สักอย่าง"
            )
        ]
    }
        ...
        'Thai': [
            TranslationList(
                TextList=[
                    ...
                    TextValue(ID=2,text="きみ… 大丈夫⁉"),
                    TextValue(ID=3,text="なんだこいつ 空気読めて ないのか…？"),
                    TextValue(ID=4,text="お兄ちゃん、早く来て！"),
                    TextValue(ID=5,text="ったく… しょうがねぇな")
                ]
            ),
            TranslationList(
                TextList=[
                    TextValue(ID=1,text="อายจัง… ไม่อยากเป็นจุดสนใจ… อยากหายไปเลย…"),
                    TextValue(ID=2,text="เธอ… ไม่เป็นไรนะ⁉"),
                    TextValue(ID=3,text="ไอ้นี่มัน… อ่านบรรยากาศไม่ออกเหรอวะ…？"),
                    TextValue(ID=4,text="พี่! มาเร็วๆ สิ!"),
                    TextValue(ID=5,text="ชิ… ทำไม่ได้สักอย่าง")
                ]
            )
        ]
    }
