"""
Redis protocol constants and connection helpers for the manga-translator infrastructure.

Provides:
- Shared async Redis connection pool
- Stream/PubSub key constants (the "contract" between API and Worker)
- Job queue helpers (enqueue, subscribe, result storage)
...
# ---------------------------------------------------------------------------
# Constants — the contract between API and Worker
# ---------------------------------------------------------------------------
