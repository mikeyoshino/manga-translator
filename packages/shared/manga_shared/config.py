"""
Shared configuration types for the manga-translator pipeline.

This module is the single source of truth for:
- Pipeline component enums (Detector, Ocr, Translator, etc.)
- Pydantic config models (Config, RenderConfig, etc.)
- Context dict (lightweight pipeline state container)
- Language constants (VALID_LANGUAGES, LANGUAGE_ORIENTATION_PRESETS)
"""
...
# ---------------------------------------------------------------------------
# Language constants (moved from translators/common.py and utils/textblock.py)
# ---------------------------------------------------------------------------
...
# Determines render direction per language
...
# ---------------------------------------------------------------------------
# Context — lightweight dict-subclass for passing pipeline state
# ---------------------------------------------------------------------------

class Context(dict):
    """Adapted from argparse.Namespace — attribute-style access on a dict."""
...
class TranslatorChain:
    def __init__(self, string: str):
        ...
        """
        # Lazy import: only available in worker context where manga_translator is installed
