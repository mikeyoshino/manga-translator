...
import server.admin_queries as aq
...
@admin_router.get("/users/{user_id}/projects")
...
@admin_router.post("/users/{user_id}/deduct")
...
@admin_router.get("/transactions/summary")
...
@admin_router.get("/activity/usage")
