...
def create_promptpay_charge(user_id: str, token_amount: int) -> dict[str, Any]:
    ...
    charge = omise.Charge.create(
        ...
        metadata={"user_id": user_id, "tokens_to_credit": token_amount, "payment_method": "promptpay"},
    )
...
def create_card_charge(user_id: str, token_amount: int, card_token: str) -> dict[str, Any]:
    ...
    charge = omise.Charge.create(
        ...
        metadata={"user_id": user_id, "tokens_to_credit": token_amount, "payment_method": "card"},
    )
